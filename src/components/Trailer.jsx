  ...
  return (
    <div className='text-3xl text-white z-40 flex justify-center items-center absolute h-screen w-screen top-0 left-0' style={
      ...
      <div className='relative'>
        <ReactPlayer height={720} width={1228} url={`https://www.youtube.com/watch?v=${ytVideo.videos?.key}`} playing />
      </div>
      <Link className='absolute top-0 right-0 mr-[8vw] mt-[5vh] bg-red-300 rounded-full p-2' onClick={() => navigate(-1)} ><RxCross1 />
</Link>
    </div>
  );
};
